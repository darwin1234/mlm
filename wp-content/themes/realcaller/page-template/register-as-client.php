    ...
    <div id="registration_dealder" class="container">
        <div class="row ">
            <div class="col-md-7 m-auto py-5">
                ...
                <div class="row">
                    <div class="col mb-3 ">
                        <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" aria-describedby="email address">
                    </div>
                    <div class="col mb-3">
                        <input type="text" class="form-control" id="business_name" name="business_name" placeholder="Business Name" aria-describedby="email address">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        <input type="text" class="form-control" id="phone_number" name="phone" placeholder="Phone Number" aria-describedby="Phone Number">
                    </div>
                    <div class="col mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        <input type="text" class="form-control" id="state" name="state" placeholder="State" aria-describedby="City">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        <input type="text" class="form-control" id="postalCode" name="postal_code" placeholder="Postal Code" aria-describedby="City">
                    </div>
                    <div class="col mb-3">
                        <!-- All countries -->
                        <!-- Code and Name -->
                        <select class="form-control" autocomplete="country" name="country" placeholder="Country">
