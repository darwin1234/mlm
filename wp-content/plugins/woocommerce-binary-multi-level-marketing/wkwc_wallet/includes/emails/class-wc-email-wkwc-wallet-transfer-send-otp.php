...
if ( ! class_exists( 'WC_Email_WKWC_Wallet_Transfer_Send_OTP' ) ) {
	...
	class WC_Email_WKWC_Wallet_Transfer_Send_OTP extends WC_Email {
		...
		public function __construct() {
			...
			$this->title       = esc_html__( 'Send Wallet Transaction OTP', 'wkwc_wallet' );
			$this->description = esc_html__( 'OTP will be sent when transferring wallet amount.', 'wkwc_wallet' );
		...
		public function get_default_heading() {
			return __( 'Wallet Transaction OTP', 'wkwc_wallet' );
		}
		...
		public function get_default_subject() {
			return __( '6 digit wallet transaction OTP {site_title}', 'wkwc_wallet' );
		}
	}
}
