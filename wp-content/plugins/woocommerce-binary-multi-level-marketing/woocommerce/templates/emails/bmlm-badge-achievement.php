<?php
/**
 * Badge Achievement Email template
 *
...
<p>
	<?php
	/* translators: %s is badge name*/
	echo wp_sprintf( esc_html__( 'You received a new %s Badge, your received bonus details are following...', 'binary-mlm' ), esc_html( $data['user_badge'] ) );
	?>
	<br/>
</p>
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				<th class="td" colspan="2" scope="col" style="text-align:center;"><?php esc_html_e( 'Bonus Details', 'binary-mlm' ); ?></th>
			</tr>
			<tr>
		...
		<tbody>
			<tr>
				...
				<?php esc_html_e( 'Badge', 'binary-mlm' ); ?>
				</td>
				<td class="td" style="text-align:center; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap:break-word;">
				<?php echo esc_html( $data['user_badge'] ); ?>
				</td>
			</tr>

			<tr>
				<td class="td" style="text-align:center; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap:break-word;">
				<?php esc_html_e( 'Bonus Amount', 'binary-mlm' ); ?>
				</td>
				<td class="td" style="text-align:center; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap:break-word;">
				<?php echo wp_kses_post( wc_price( esc_html( $data['commission'] ), array( 'decimals' => 2 ) ) ); ?>
				</td>
			</tr>
