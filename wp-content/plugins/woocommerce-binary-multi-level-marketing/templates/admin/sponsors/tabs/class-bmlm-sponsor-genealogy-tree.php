...
if ( ! class_exists( 'BMLM_Sponsor_Genealogy_Tree' ) ) {
	/**
	 * Sponsor Genealogy Tree
	 */
	class BMLM_Sponsor_Genealogy_Tree {
		/**
		 * Construct
		 */
		...
		public function get_template() {
			...
			<div class="bmlm-search-tree" >
				<div class="bmlm-action-container">
					<button class="button button-primary bmlm-btn-action btn-fullscreen" onclick="params.funcs.toggleFullScreen()">
