<?php
/**
 * Sponsor Lifetime Business Template.
 *
...
if ( ! class_exists( 'BMLM_Lifetime_Business_Metabox' ) ) {
	/**
	 * BMLM Lifetime Business Metabox
	 */
	class BMLM_Lifetime_Business_Metabox {
		/**
		 * Sponsor.
		 *
		 * @var object Sponsor.
			...
			<table class="widefat bmlm-widefat fixed">
				<thead>
					<tr>
						<th colspan="2">
							<strong>
								<?php esc_html_e( 'Lifetime', 'binary-mlm' ); ?>
							</strong>
						</th>
					</tr>
				</thead>
