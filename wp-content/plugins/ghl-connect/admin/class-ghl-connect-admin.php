...
class GHLCONNECT_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', plugins_url( 'js/select2.min.js', __FILE__ ) , array('jquery'), '2.0.6', true );
        wp_enqueue_script( 'ghlconnect_admin_script', plugins_url( 'js/admin-scripts.js', __FILE__ ) , array('jquery'), '2.0.6', true );
	}
